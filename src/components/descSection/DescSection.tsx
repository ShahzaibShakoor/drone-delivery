export default function DescSection() {
  return (
    <section className="grid grid-cols-[4fr_3fr] px-[16%] pt-24 pb-56 desc-background m-0 gap-10">
      <div className="flex flex-col gap-10 self-center p-9">
        <h1 className="font-arealMT text-5xl">
          Look, up in the <span className="text-[#34AAFF]">sky</span>,<br/>it’s your
          dinner
        </h1>
